...
@registry.register_model("blip2_pformer_t5")
class Blip2PformerT5(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_pformer_flant5xl": "configs/models/blip2/blip2_pretrain_flant5xl.yaml",
        "pretrain_pformer_flant5xxl": "configs/models/blip2/blip2_pretrain_flant5xxl.yaml",
    }
    ...
    def forward(self, samples):
        ...
        with torch.no_grad():
            ...
            inputs_t5_ref = self.Pformer.cls_proj(text_output.last_hidden_state[:, 0, :])
            inputs_t5_ref = inputs_t5_ref.reshape(bsz, n_query, hdim)
            inputs_t5_ref = self.Pformer.pooler(inputs_t5_ref)
            inputs_t5_ref = self.Pformer.t5_proj(inputs_t5_ref)
