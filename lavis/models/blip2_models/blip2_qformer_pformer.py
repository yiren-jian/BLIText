...
@registry.register_model("blip2_pformer")
class Blip2QformerPformer(Blip2Base):
    """
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_pformer": "configs/models/blip2/blip2_pretrain.yaml",
    }
    ...
    def __init__(
        ...
        self.Pformer.opt_proj = nn.Linear(
            self.Pformer.config.hidden_size, opt_hidden_size
        )
