...
from lavis.models.blip2_models.pformer_opt import PformerOPT   ##### added model
from lavis.models.blip2_models.pformer_t5 import PformerT5   ##### added model
from lavis.models.blip2_models.blip2_qformer_pformer import Blip2QformerPformer   ##### added model
from lavis.models.blip2_models.blip2_pformer_opt import Blip2PformerOPT   ##### added model
from lavis.models.blip2_models.blip2_pformer_t5 import Blip2PformerT5   ##### added model
from lavis.models.blip2_models.blip2_pformer import Blip2Pformer   ##### added model
...
__all__ = [
    ...
    "BlipVQA",
    "Blip2Qformer",
    "PformerOPT",   ### added model
    "PformerT5",   ### added model
    "Blip2QformerPformer",   ### added model
    "Blip2PformerOPT",   ### added model
    "Blip2PformerT5",   ### added model
    "Blip2Pformer",   ### added model
    "Blip2Base",
    "Blip2ITM",
    "Blip2OPT",
    "Blip2T5",
